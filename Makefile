...
eps:
	@inkscape --export-type=eps --export-ps-level=2 --export-filename=matrix-1.eps --export-text-to-path matrix-1.svg 2>/dev/null || inkscape -E matrix-1.eps --export-ps-level=2 --export-text-to-path matrix-1.svg 2>/dev/null || inkscape -E matrix-1.eps --export-text-to-path matrix-1.svg
